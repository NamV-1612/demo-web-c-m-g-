...
- **Backend**: Triển khai qua Render.com kết nối qua API thực tế. Yêu cầu thiết lập khởi chạy Server sau khi Database đã kết nối xong để tránh lỗi Buffering Timeout.
